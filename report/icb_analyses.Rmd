...
TIDE_hugo = read_csv("results/TIDE_output_hugo.csv")
TIDE_Snyder = read_csv("results/TIDE_output_Snyder.csv")
TIDE_VanAllen = read_csv("results/TIDE_output_VanAllen.csv")
