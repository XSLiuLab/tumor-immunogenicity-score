...
save(van2015_roc, hugo2016_roc, snyder2017_roc, file = "results/ROC_ObjList.RData")
```
...
show_extcols = c("TIDE_comb_TMB", "APS7_Sig", "APS7_Sig_comb_TMB", "APS_MHC_II", "APS_MHC_II_comb_TMB")
...
```{r}
auc_ext = cowplot::plot_grid(p_auc_ext1, p_auc_ext2, p_auc_ext3, align = "h", nrow = 1) 
ggsave2("extra_auc.pdf", auc_ext, width = 8, height = 2.5)
```
...
plot_list = list(
  ...
  p_surv_TIDE[[1]]$plot, p_surv_TIDE[[2]]$plot, p_surv_TIDE[[1]]$plot
)
...
>>>>>>> 30c35b02d0a404d3a1ab9ad4f2f53620ca083e28
...
```{r}
save_plot("comp_profile.pdf", plot_res, nrow = 5, ncol = 3)
```
