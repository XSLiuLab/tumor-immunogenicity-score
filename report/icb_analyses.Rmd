...
GSE78220.APS = tibble(PatientID = names(APS_hugo), APS=APS_hugo)
...
info_hugo = info_hugo[,c(1:5, 14,15, 6:13)]
...
APS_VanAllen = gsva.VanAllen2015[[1]]$APM
...
### Compare ROC and survival status
...
ggroc(list(VanAllen2015_roc1, VanAllen2015_roc3), legacy.axes = TRUE) + labs(color = "Predictor") + 
    ggpubr::theme_classic2(base_size = 12, base_family = "Arial")

auc(VanAllen2015_roc1)
auc(VanAllen2015_roc2)
auc(VanAllen2015_roc3)
